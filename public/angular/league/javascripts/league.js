var league = angular.module('rokta.league', ['rokta.events', 'rokta.stats', 'rokta.filter']);
...
league.controller('LeagueCtrl', ['$scope', 'Events', 'Stats', function($scope, Events, Stats) {
  Stats.refresh();
...
league.controller('LastGameCtrl', ['$scope', 'Events', 'Stats', function($scope, Events, Stats) {
  Events.listenTo($scope, Stats, function() {
	$scope.lastGame = Stats.stats.lastGame;
  });
}]);

league.controller('TodayCtrl', ['$scope', 'Events', 'Stats', 'ResultGrouper', function($scope, Events, Stats, ResultGrouper) {
  Events.listenTo($scope, Stats, function() {
	var stats = Stats.stats;
...
league.controller('CurrentStreaksCtrl', ['$scope', 'Events', 'Stats', 'StreaksGrouper', function($scope, Events, Stats, StreaksGrouper) {
  Events.listenTo($scope, Stats, function() {
