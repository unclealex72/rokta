 ...
 *
 */
public class League implements Comparable<League>, Serializable {
	...
	private Date i_lastGameDate;
	
	@Override
	public int compareTo(League o) {
		return o.getLastGameDate().compareTo(getLastGameDate());
	}
	
	@Override
	public boolean equals(Object obj) {
		return obj instanceof League && compareTo((League) obj) == 0;
	}
	
	@Override
	public int hashCode() {
		return getLastGameDate().hashCode();
	}
	...
	public Date getLastGameDate() {
		return i_lastGameDate;
	}
	
	public void setLastGameDate(Date lastGameDate) {
		i_lastGameDate = lastGameDate;
	}
}
