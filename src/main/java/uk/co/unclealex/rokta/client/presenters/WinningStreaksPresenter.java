...
public class WinningStreaksPresenter extends StreaksPresenter {
	...
	@Inject
	public WinningStreaksPresenter(@Assisted GameFilter gameFilter, InformationService informationService,
	...
	protected String createStreaksTitle(TitleMessages titleMessages, SortedSet<Streak> allStreaks) {
		return titleMessages.winningStreaksSubtitle(allStreaks.size());
	}

	@Override
	protected SortedSet<Streak> asSpecificInformation(CurrentInformation currentInformation) {
		return currentInformation.getWinningStreaks();
	}
}
