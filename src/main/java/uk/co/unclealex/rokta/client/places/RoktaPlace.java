...
public abstract class RoktaPlace extends Place {
	...
	public RoktaPlace(GameFilter gameFilter) {
		super();
	...
	public boolean isEqual(RoktaPlace other) {
		return getGameFilter().equals(other.getGameFilter());
	}
	
	public abstract <T> T accept(RoktaPlaceVisitor<T> visitor);

	public abstract RoktaPlace withGameFilter(GameFilter gameFilter);
	
	protected abstract static class Tokenizer<P extends RoktaPlace> implements PlaceTokenizer<P> {
